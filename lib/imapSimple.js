...
ImapSimple.prototype.end = function () {
    ...
    // We want to explicitly ignore 'ECONNRESET' errors when calling .end(),
    ...
    function ignoreECONNRESETErrorHandler(err) {
    ...
    self.imap.on('error', ignoreECONNRESETErrorHandler);
    ...
    self.imap.once('close', function () {
        self.imap.removeListener('error', ignoreECONNRESETErrorHandler);
    });
