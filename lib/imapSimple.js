 ...
 *
 * @param {string|Array} message The messages uid
 * @param {string|Array} options Option "mailbox" specifies mailbox, option "flag" indicate custom or predefined flag,
     such as '\\Draft', '\\Unread'
 * @param {function} [callback] Optional callback, receiving signature (err)
 * @returns {undefined|Promise} Returns a promise when no callback is specified, resolving when the action succeeds.
 * @memberof ImapSimple
 */
