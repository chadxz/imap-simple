...
/**
 * Move message to another box
 */
ImapSimple.prototype.moveMessage = function(message, label) {
    var self = this;
    return new Promise(function(resolve, reject) {
        self.imap.move(message, label, function(err, results) {
           if (err) reject(err);
...
/**
 * Set label of message
 */
ImapSimple.prototype.addMessageLabel = function(message, label) {
    var self = this;
    return new Promise(function(resolve, reject) {
        self.imap.addLabels(message, label, function(err, results) {
            if (err) reject(err);
            else resolve(results);
        });
    });
